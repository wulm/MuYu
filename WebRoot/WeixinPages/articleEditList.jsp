...
<html>
  <head>
	...
	<script>
	function gotoDeleteArticle(articleId,articleType){
            var d = dialog({
                content: '确定删除？',
                okValue: '确 定',
                ok: function() {
			...
			<s:iterator value="articleList" id="articleCell">
				<li class="mui-table-view-cell mui-media">
					<div class="mui-slider-left mui-disabled">
						...
						<button id='deleteBtn'  type="button" onclick="gotoDeleteArticle(<s:property value="#articleCell.articleId" />,<s:property value="#articleCell.articleType" />);" class="mui-btn mui-btn-red ">删除</button>
					</div>
